...
API_URL = "http://127.0.0.1:8000/predict"  # http://127.0.0.1:8000 -> Fast Api home Url
...
if st.button("Predict Premium Category"):
    ...
    try:
        ...
        st.error("Could not connect to the FAST API server. Make sure it's running on port 8000.")